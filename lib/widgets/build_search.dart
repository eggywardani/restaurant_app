      ...
      builder: (context, value, child) {
        if (value.state == ResultState.Loading) {
          ...
          return ListView.builder(
            itemCount: value.searchResult?.restaurants?.length,
            itemBuilder: (context, index) {
              var items = value.searchResult!.restaurants!;
              return RestaurantItem(restaurant: items[index]);
            },
          );
          ...
          return Center(
            child: Column(
              children: [
                ...
                Text(
                  "oops...something went wrong" + value.message,
                  style: myTextTheme.headline6,
                )
              ],
            ),
